  ...
  config = function()
    ...
    bufferline.setup {
      options = {
        ...
        separator_style = 'thick', -- "slant" | "slope" | "thin" | { 'any', 'any' }
    ...
    local function close_buffer()
      ...
      require('bufferline').cycle(-1) -- Moverse al buffer anterior antes de cerrar
      vim.api.nvim_buf_delete(bufnum, { force = true })
    end

    vim.keymap.set('n', '<leader><C-w>', close_buffer, { noremap = true, silent = true, desc = 'Close current buffer' })
  end,
}
