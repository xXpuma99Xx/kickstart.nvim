return {
  ...
  config = function()
    ...
    vim.keymap.set({ 'n', 'i' }, '<D-b>', api.tree.toggle, { noremap = true, silent = true, nowait = true })
    vim.keymap.set({ 'n', 'i' }, '<D-M-b>', '<cmd> NvimTreeFocus <CR>', { desc = 'nvim-tree: Focus', noremap = true, silent = true })
